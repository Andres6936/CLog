...
#include "Levin/SeverityLevel.hpp"
...
namespace Levin
{
	...
	public:
		 ...
		 */
		virtual void Message(SeverityLevel level, std::wstring_view local) = 0;
	...
	protected:
		...
		[[nodiscard]] std::wstring ToString(SeverityLevel level) const noexcept;
	};
